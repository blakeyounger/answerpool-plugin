...
- `sec_events`, `sec_company`, `reg_rules`, `funding_signals`, `technology_emerging`,
  ...
  `ANSWERPOOL_API_KEY`. Without one they return a 401 with purchase instructions
  (credits from $1 at https://answerpool.io/v1/credits/checkout).
- Failed calls are never charged. Docs: https://answerpool.io/llms.txt
